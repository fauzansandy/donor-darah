        ...
        <div class="container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('/dealer/user/new') }}">NEW</a></li>
                    <li class="breadcrumb-item"><a href="{{ url('/dealer/user/new/grab/masterinsentifscheme') }}">>MASTER SKEMA INSENTIF</a></li>
                ...
                @component('components.table', ['data' => $data, 'props' => []])
                    ...
                    @scopedslot('record', ($item, $props))
                        <tr>
                            ...
                            <td class="v-align-middle">
                                <div class="btn-group">
                                    <a href="{{ url('/dealer/user/new') }}" class="btn btn-xs btn-success btn-table-action">Pilih Sales</a>
                                </div>
                            </td>
                        </tr>
                    @endscopedslot
