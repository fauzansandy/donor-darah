        ...
        <div class="container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('/content/master/termco') }}">Content Master Period Provision</a></li>
...
@section('script')
    @include('app.content.master.period.detail.scripts.index')
@endsection

@section('formValidationScript')
    @include('app.content.master.period.detail.scripts.form')
@endsection
