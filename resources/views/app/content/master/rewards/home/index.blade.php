        ...
        <div class="container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Content Master Rewards</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="container-fluid container-fixed-lg p-t-10">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <ul class="navbar-nav d-flex flex-row">
                                <li class="nav-item">
                                    <a href="{{ url('/content/master/cash-rewards/new') }}"><i class="fas fa-plus"></i> Create</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-4">
        ...
        <div class="card card-white">
            <div class="card-header ">
                <div class="card-title">Content Master Rewards Data</div><br>
            </div>
            <div class="card-body">
                @component('components.table', ['data' => $data, 'props' => []])
                    ...
                    @scopedslot('record', ($item, $props))
                        <tr>
                            ...
                            <td class="v-align-middle">
                                <div class="btn-group">
                                    <a href="{{ url('/content/master/cash-rewards/1') }}" class="btn btn-xs btn-success btn-table-action">DETAIL</a>
                                </div>
                            </td>
                        </tr>
                    @endscopedslot
