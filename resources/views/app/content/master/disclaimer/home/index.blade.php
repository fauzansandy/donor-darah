...
@section('contentManagementMasterContentDisclaimerMenuClass', 'active')
        ...
        <div class="container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Content Master Disclaimer</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="container-fluid container-fixed-lg p-t-10">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <ul class="navbar-nav d-flex flex-row">
                                <li class="nav-item">
                                    <a href="{{ url('/content/master/disclaimer/1') }}"><i class="fas fa-eye"></i> Detail</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-4">
        ...
        <div class="card card-white">
            <div class="card-header ">
                <div class="card-title">Content Master Disclaimer Data</div><br>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group form-group-default">
                                <label>Wording</label>
                                <span>Ini adalah wording untuk halaman simulasi kredit</span>
                            </div>
                        </div>
                    </div>
                </div>
