        ...
        <div class="container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('/content/master/faq') }}">Disclaimer</a></li>
                    <li class="breadcrumb-item active">DUMMY_DISCLAIMER_TITLE</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 act-left">
                                <a href="{{ UrlPrevious(url('/content/master/disclaimer')) }}" class="btn btn-block btn-primary btn-cons m-b-10"><i class="fas fa-arrow-left"></i> Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
