        ...
        <div class="card card-default m-t-20">
            <div class="card-body">
                <div>
                    ...
                    <div>
                        <input type="hidden" style="width:50px" type="text" name="transfusion_id" value="{{ $data['patient_transfusions'][0]->id }}"/>
                    </div>
                ...
                <div>
                    <table class="table table-bordered table-sm">
                        ...
                        <tr>
                            ...
                            <td><input style="width:50px" type="text" name="b30m_suhu" value="{{ $data['patient_transfusions'][0]->b30m_suhu }}"/></td>
                            <td><input style="width:50px" type="text" name="b30m_respirasi" value="{{ $data['patient_transfusions'][0]->b30m_respirasi }}"/></td>
                        ...
                        <tr>
                            ...
                            <td><input style="width:50px" type="text" name="suhu" value="{{ $data['patient_transfusions'][0]->suhu }}"/></td>
                            <td><input style="width:50px" type="text" name="respirasi" value="{{ $data['patient_transfusions'][0]->respirasi }}"/></td>
                        ...
                        <tr>
                            ...
                            <td><input style="width:50px" type="text" name="a15m_suhu" value="{{ $data['patient_transfusions'][0]->a15m_suhu }}"/></td>
                            <td><input style="width:50px" type="text" name="a15m_respirasi" value="{{ $data['patient_transfusions'][0]->a15m_respirasi }}"/></td>
                        ...
                        <tr>
                            ...
                            <td><input style="width:50px" type="text" name="a1h_suhu" value="{{ $data['patient_transfusions'][0]->a1h_suhu }}"/></td>
                            <td><input style="width:50px" type="text" name="a1h_respirasi" value="{{ $data['patient_transfusions'][0]->a1h_respirasi }}"/></td>
                        ...
                        <tr>
                            ...
                            <td><input style="width:50px" type="text" name="a2h_suhu" value="{{ $data['patient_transfusions'][0]->a2h_suhu }}"/></td>
                            <td><input style="width:50px" type="text" name="a2h_respirasi" value="{{ $data['patient_transfusions'][0]->a2h_respirasi }}"/></td>
                        ...
                        <tr>
                            ...
                            <td><input style="width:50px" type="text" name="a3h_suhu" value="{{ $data['patient_transfusions'][0]->a3h_suhu }}"/></td>
                            <td><input style="width:50px" type="text" name="a3h_respirasi" value="{{ $data['patient_transfusions'][0]->a3h_respirasi }}"/></td>
                        ...
                        <tr>
                            ...
                            <td><input style="width:50px" type="text" name="a4h_suhu" value="{{ $data['patient_transfusions'][0]->a4h_suhu }}"/></td>
                            <td><input style="width:50px" type="text" name="a4h_respirasi" value="{{ $data['patient_transfusions'][0]->a4h_respirasi }}"/></td>
                        ...
                        <tr>
                            ...
                            <td><input style="width:50px" type="text" name="d_suhu" value="{{ $data['patient_transfusions'][0]->d_suhu }}"/></td>
                            <td><input style="width:50px" type="text" name="d_respirasi" value="{{ $data['patient_transfusions'][0]->d_respirasi }}"/></td>
                        ...
                        <tr>
                            ...
                            <td><input style="width:50px" type="text" name="pt4_suhu" value="{{ $data['patient_transfusions'][0]->pt4_suhu }}"/></td>
                            <td><input style="width:50px" type="text" name="pt4_respirasi" value="{{ $data['patient_transfusions'][0]->pt4_respirasi }}"/></td>
